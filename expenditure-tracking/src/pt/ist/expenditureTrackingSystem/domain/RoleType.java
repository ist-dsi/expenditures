...
public enum RoleType implements IRoleEnum, IPresentableEnum {
    ...
    ACQUISITION_CENTRAL, ACQUISITION_CENTRAL_MANAGER, ACCOUNTING_MANAGER, PROJECT_ACCOUNTING_MANAGER, MANAGER, TREASURY_MANAGER, SUPPLIER_MANAGER, STATISTICS_VIEWER;
