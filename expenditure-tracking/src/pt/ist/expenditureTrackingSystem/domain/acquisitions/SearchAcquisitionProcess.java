...
public class SearchAcquisitionProcess extends Search<AcquisitionProcess> {
	...
	private boolean matchesSearchCriteria(final AcquisitionRequest acquisitionRequest) {
	    ...
	    return matchCriteria(processId, identification)
	    		...
	    		&& matchCriteria(getSupplier(), supplier)
	...
	private boolean matchCriteria(final Boolean hasAvailableAndAccessibleActivityForUser, final AcquisitionRequest acquisitionRequest) {
	...
	private boolean matchCriteria(final Unit unit, final AcquisitionRequest acquisitionRequest) {
	    return unit == null
	    		|| unit == acquisitionRequest.getRequestingUnit()
	...
	private boolean matchCriteria(final Supplier criteria, final Supplier supplier) {
	    return criteria == null || criteria == supplier;
	}
...
//		    Collections.EMPTY_SET;
	...
	return hasCriteria(processId)
		...
		|| hasAvailableAndAccessibleActivityForUser != null;
    }
