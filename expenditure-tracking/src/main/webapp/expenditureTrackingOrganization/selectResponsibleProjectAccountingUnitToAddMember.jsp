...
<h2><bean:message key="projectAccountingUnit.title.add.responsible" bundle="EXPENDITURE_RESOURCES"/></h2>
...
<logic:notEmpty name="accountingUnits">
	<bean:define id="selectUrl">/expenditureTrackingOrganization.do?method=addResponsibleProjectAccountingUnit&amp;personOid=<bean:write name="person" property="externalId"/></bean:define>
