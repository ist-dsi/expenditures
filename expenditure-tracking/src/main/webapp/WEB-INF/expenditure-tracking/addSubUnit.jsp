...
.ui-autocomplete-loading {
	background: url(/dot/images/autocomplete/spinner.gif) no-repeat right
		center
}
</style>
<%
...
<script
	src='<%=contextPath + "/webjars/highcharts/4.0.4/highcharts.js"%>'></script>
<script
	src='<%=contextPath + "/webjars/highcharts/4.0.4/highcharts-more.js"%>'></script>
<script
...
<div class="form-group">
	<h3>
		<spring:message
			code="activity.module.mission.person.mission.addSubunit"
...
<form id="addForm" class="form-horizontal" role="form"
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="unit" value=""
				required="required" /> <input type="hidden" name="unitId"
				id="unitId" value="" />
		</div>
	</div>
	...
	<div class="form-group">
		<label class="control-label col-sm-2" for="relationType"> <spring:message
				code="label.mission.Relationship.type"
				text="label.mission.Relationship.type" />
		</label>
		<div class="col-sm-10">
				...
				.autocomplete(
						{
							...
							source : function(request, response) {
								...
								$
										.get(
												pageContext
														+ "/expenditure-tracking/manageMissions/allUnit/json",
												request,
												function(result) {
													response($
															.map(
