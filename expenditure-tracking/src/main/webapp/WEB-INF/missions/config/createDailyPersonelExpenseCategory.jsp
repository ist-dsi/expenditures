...
<div class="page-body">
    ...
    <form class="form-horizontal" action="<%= request.getContextPath() %>/missions/config/createDailyPersonelExpenseCategory/${table.externalId}" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    <input type="number" step="0.01" min="0" name="value" class="form-control" required="required">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" step="0.01" min="0" name="minSalaryValue" class="form-control" required="required">
            </div>
        </div>
