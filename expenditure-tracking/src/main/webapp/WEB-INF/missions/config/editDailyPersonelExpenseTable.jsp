...
<div class="page-body">
    ...
    <form class="form-horizontal" action='<%= request.getContextPath() %>/missions/config/editDailyPersonelExpenseTable/${table.externalId}' method="POST">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="applicableSince" placeholder="dd/MM/yyyy" class="form-control" required="required" value='${table.aplicableSince.toString("dd/MM/yyyy")}'>
            </div>
        </div>
            ...
            <div class="col-sm-10">
                <select name="missionType" class="form-control" required="required">
                    <c:forEach items="${missionTypes}" var="type">
                        <option value="${type.name}" ${table.aplicableToMissionClass.name.equals(type.name) ? "selected='selected'" : ""}>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="<%= contextPath %>/missions/config/viewDailyPersonelExpenseTable/${table.externalId}" class="btn btn-default"><spring:message code="link.cancel"/></a>
            </div>
        </div>
    </form>
