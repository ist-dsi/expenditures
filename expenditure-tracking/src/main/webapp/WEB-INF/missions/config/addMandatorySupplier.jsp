...
<div class="page-header">
    <h2><spring:message code="missionsConfiguration.link.addSupplier"></spring:message></h2>
</div>
...
<div class="page-body">
    ...
    <form class="form-horizontal" action="<%= request.getContextPath() %>/missions/config/addMandatorySupplier" method="POST">
        <div class="form-group">
            <label for="supplierOid" class="col-sm-2 control-label">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-default"><spring:message code="link.submit"/></button>
            </div>
        </div>
    </form>
