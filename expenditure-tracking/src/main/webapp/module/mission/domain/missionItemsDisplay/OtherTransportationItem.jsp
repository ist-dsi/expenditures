...
<div class="infobox">
	...
	<table class="tstyle1" style="width: 100%;">
		...
		<tr>
			<th>
				<bean:message key="label.mission.item.transportation.typeOfTransportation" bundle="MISSION_RESOURCES"/>:
			</th>
			<td>
				<fr:view name="missionItem" property="typeOfTransportation"/>
			</td>
		</tr>
		<tr>
			<th>
