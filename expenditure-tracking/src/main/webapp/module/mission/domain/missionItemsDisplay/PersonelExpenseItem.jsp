...
<div class="infobox">
	...
	<table class="tstyle1" style="width: 100%;">
		...
		<tr>
			<th style="width: 185px;"><bean:message key="label.mission.item.personel.expense.interval" bundle="MISSION_RESOURCES"/>:</th>
			<td><fr:view name="missionItem" property="start"/> - <fr:view name="missionItem" property="end"/></td>
		</tr>
		<tr>
			<th style="width: 185px;"><bean:message key="label.mission.item.personel.expense.dailyPersonelExpenseCategory" bundle="MISSION_RESOURCES"/>:</th>
			<td><fr:view name="missionItem" property="dailyPersonelExpenseCategory.description"/></td>
		</tr>
		<tr>
			<th style="width: 185px;"><bean:message key="label.mission.item.value" bundle="MISSION_RESOURCES"/>:</th>
			<td><fr:view name="missionItem" property="value"/></td>
		</tr>
		<tr>
