	...
	<logic:notEmpty name="units">
		<table class="width100pc">
			<logic:iterate id="unit" name="units">
				<bean:define id="oid" name="unit" property="externalId" type="java.lang.String"/>
				<tr>
					<td>
						<html:link page="<%= "/expenditureTrackingOrganization.do?method=viewOrganization&unitOid=" + oid %>">
			...
			<tr>
				<td class="aright" style="padding-bottom: 8px !important;">
				<bean:define id="personOID" name="person" property="externalId" type="java.lang.String"/>
				<html:link page="<%= "/expenditureTrackingOrganization.do?method=viewPerson&personOid=" + personOID + "#myAuthorizations" %>"><bean:message key="label.viewAll" bundle="EXPENDITURE_RESOURCES"/></html:link>
				</td>
			</tr>
		</table>
	</logic:notEmpty>
	<logic:empty name="units">
		<p><em><bean:message key="label.no.myUnits" bundle="EXPENDITURE_RESOURCES"/>.</em></p>
	</logic:empty>
</logic:notPresent>
