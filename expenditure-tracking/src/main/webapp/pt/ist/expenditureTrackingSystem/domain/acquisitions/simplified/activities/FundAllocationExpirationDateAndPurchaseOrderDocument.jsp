...
<h3>
	...
	<logic:iterate id="supplierContact" name="process" property="request.supplier.supplierContactSet" type="module.finance.domain.SupplierContact">
		...
		<div class="ruler1">
			<bean:define id="url" type="java.lang.String">/workflowProcessManagement.do?method=actionLink&amp;activity=FundAllocationExpirationDateAndPurchaseOrderDocument&amp;processId=<bean:write name="process" property="externalId"/>&amp;parameters=supplierContact&amp;supplierContact=<bean:write name="supplierContact" property="externalId"/></bean:define>
