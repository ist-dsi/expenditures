/*
 * @(#)PaymentProcessYearProvider.java
 *
...
public class MultipleConsultationProcessCandidateSupplierProvider implements DataProvider {
    ...
    public Object provide(final Object source, final Object currentValue) {
        final SupplierCandidacyDocumentUploadBean bean = (SupplierCandidacyDocumentUploadBean) source;
        final MultipleSupplierConsultationProcess process = bean.getProcess();
        final MultipleSupplierConsultation consultation = process.getConsultation();
        return consultation.getSupplierSet();
    }
