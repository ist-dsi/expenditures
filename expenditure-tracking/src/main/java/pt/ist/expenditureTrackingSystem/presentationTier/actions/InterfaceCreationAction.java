...
public class InterfaceCreationAction extends ContextBaseAction {
	...
	@CreateNodeAction(
			...
			key = "add.node.expenditure-tracking.interface",
...
//		"resources.ExpenditureOrganizationResources", "label.listUnconnectedUnits", statisticsGroup);
	...
	@CreateNodeAction(
			bundle = "EXPENDITURE_RESOURCES",
			key = "add.node.expenditure-tracking.interface.config",
			groupKey = "label.module.expenditure-tracking")
	...
	@CreateNodeAction(
			bundle = "EXPENDITURE_RESOURCES",
			key = "add.node.expenditure-tracking.interface.announcements",
			groupKey = "label.module.expenditure-tracking")
