...
//	}
	...
	setSupplierFundAllocationManagerGroup(pt.ist.bennu.core.domain.groups.Role.getRole(RoleType.SUPPLIER_FUND_ALLOCATION_MANAGER));
	...
	final User user = UserView.getCurrentUser();
	final pt.ist.bennu.core.domain.groups.Role role = pt.ist.bennu.core.domain.groups.Role.getRole(pt.ist.bennu.core.domain.RoleType.MANAGER);
