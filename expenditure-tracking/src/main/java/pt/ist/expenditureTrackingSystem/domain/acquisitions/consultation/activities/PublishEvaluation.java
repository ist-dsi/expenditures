...
public class PublishEvaluation extends WorkflowActivity<MultipleSupplierConsultationProcess, ActivityInformation<MultipleSupplierConsultationProcess>> {
    ...
    protected void process(final ActivityInformation<MultipleSupplierConsultationProcess> information) {
        ...
        process.setState(MultipleSupplierConsultationProcessState.PENDING_ADJUDICATION);
    }
