...
public class Address implements Serializable {
    ...
    protected void setLine1(String line1) {
        if (line1 == null || line1.isEmpty()) {
            throw new DomainException(Bundle.EXPENDITURE, "resources/ExpenditureResources", "error.address.line1.cannot.be.empty");
        }
        this.line1 = line1;
    }
    ...
    protected void setPostalCode(String postalCode) {
        if (postalCode == null || postalCode.isEmpty()) {
            throw new DomainException(Bundle.EXPENDITURE, "resources/ExpenditureResources",
                    "error.address.postalCode.cannot.be.empty");
        }
    ...
    protected void setLocation(String location) {
        if (location == null || location.isEmpty()) {
            throw new DomainException(Bundle.EXPENDITURE, "resources/ExpenditureResources",
                    "error.address.location.cannot.be.empty");
        }
