...
public enum AcquisitionProcessStateType implements IPresentableEnum, PresentableProcessState {
    ...
    AUTHORIZED {
        ...
        public String getDescriptionKey() {
            ...
            return instance.getRequireCommitmentNumber() != null && instance.getRequireCommitmentNumber().booleanValue() ? super
                    .getDescriptionKey() + ".requireCommitmentNumber" : super.getDescriptionKey();
        }
    },
