...
public class UnSubmitForApproval extends WorkflowActivity<MultipleSupplierConsultationProcess, ActivityInformation<MultipleSupplierConsultationProcess>> {
    ...
    protected void process(final ActivityInformation<MultipleSupplierConsultationProcess> information) {
        ...
        process.setState(MultipleSupplierConsultationProcessState.IN_GENESIS);
    }
