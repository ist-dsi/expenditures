...
public class RemoveFinancerInformation extends ActivityInformation<MultipleSupplierConsultationProcess> {

    private static final long serialVersionUID = 1L;

    private MultipleSupplierConsultationFinancer financer;
    
    public RemoveFinancerInformation(final MultipleSupplierConsultationProcess process,
