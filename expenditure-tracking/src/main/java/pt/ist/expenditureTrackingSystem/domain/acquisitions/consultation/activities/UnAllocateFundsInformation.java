...
public class UnAllocateFundsInformation extends ActivityInformation<MultipleSupplierConsultationProcess> {

    private static final long serialVersionUID = 1L;

    private MultipleSupplierConsultationFinancer financer;
    
    public UnAllocateFundsInformation(final MultipleSupplierConsultationProcess process,
