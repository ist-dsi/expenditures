...
public class SendForProcessTerminationWithChangesActivityInformation extends ActivityInformation<MissionProcess> implements Serializable {
	...
	return super.hasAllneededInfo() && descriptionOfChangesAfterArrival != null && !descriptionOfChangesAfterArrival.isEmpty();
    }
