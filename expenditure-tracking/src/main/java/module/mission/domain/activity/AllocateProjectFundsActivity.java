...
public class AllocateProjectFundsActivity extends MissionProcessActivity<MissionProcess, AllocateProjectFundsActivityInformation> {
	...
	final Boolean requirePriorFundAllocation = ExpenditureTrackingSystem.getInstance().getRequireFundAllocationPriorToAcquisitionRequest();
	for (final MissionItemFinancerFundAllocationBean missionItemFinancerFundAllocationBean : allocateFundsActivityInformation.getMissionItemFinancerFundAllocationBeans()) {
	    final MissionItemProjectFinancer missionItemFinancer = (MissionItemProjectFinancer) missionItemFinancerFundAllocationBean.getMissionItemFinancer();
