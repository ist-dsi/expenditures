...
public class AssociateMissionProcessActivity extends MissionProcessActivity<MissionProcess, AssociateMissionProcessActivityInfo> {
    ...
    protected ActivityLog logExecution(MissionProcess thisProcess, String operationName, User user,
        ...
        MissionProcess processToAssociate = activityInfo.getMissionProcessToAssociate();
        for (MissionProcess otherProcess : processToAssociate.getAssociatedMissionProcesses()) {
        ...
        super.logExecution(processToAssociate, operationName, user, activityInfo, argumentsDescription);
    ...
    protected String[] getArgumentsDescription(AssociateMissionProcessActivityInfo activityInformation) {
        ...
        return new String[] { activityInformation.getProcess().getProcessIdentification(), alreadyAssociatedProcessIds };
    }
}
