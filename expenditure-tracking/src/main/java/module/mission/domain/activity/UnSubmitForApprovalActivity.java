...
public class UnSubmitForApprovalActivity extends MissionProcessActivity<MissionProcess, ActivityInformation<MissionProcess>> {
	...
	return super.isActive(missionProcess, user) && !missionProcess.isUnderConstruction() && !missionProcess.isProcessCanceled()
		&& missionProcess.isRequestor(user) && !missionProcess.hasAnyAproval()
