...
public class DailyPersonelExpenseTable extends DailyPersonelExpenseTable_Base {
    ...
    public static final Comparator<DailyPersonelExpenseTable> COMPARATOR_BY_APLICABLE_SINCE = new Comparator<DailyPersonelExpenseTable>() {
	...
	if (previous != null) {
	    for (final DailyPersonelExpenseCategory dailyPersonelExpenseCategory : previous.getDailyPersonelExpenseCategoriesSet()) {
    ...
    public DailyPersonelExpenseCategory createDailyPersonelExpenseCategory(final String description, final Money value, final BigDecimal minSalaryValue) {
	...
	final SortedSet<DailyPersonelExpenseCategory> result = new TreeSet<DailyPersonelExpenseCategory>(DailyPersonelExpenseCategory.COMPARATOR_BY_VALUE);
    ...
    public static DailyPersonelExpenseTable findDailyPersonelExpenseTableFor(final String aplicableToMissionType, final LocalDate localDate) {
	DailyPersonelExpenseTable result = null;
	for (final DailyPersonelExpenseTable dailyPersonelExpenseTable : MissionSystem.getInstance().getDailyPersonelExpenseTablesSet()) {
