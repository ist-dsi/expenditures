...
public class DailyPersonalExpenseCategoryProvider implements DataProvider {
	...
	final Mission mission = personelExpenseItem.hasMissionVersion() ? personelExpenseItem.getMissionVersion().getMission() : personelExpenseItem.getMissionForCreation();
