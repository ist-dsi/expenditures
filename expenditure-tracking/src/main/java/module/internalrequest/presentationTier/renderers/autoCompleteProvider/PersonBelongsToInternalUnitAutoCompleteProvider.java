 ...
 * 
 */
public class PersonBelongsToInternalUnitAutoCompleteProvider extends InternalUnitAutoCompleteProvider {
    @Override
    protected void addUnit(SortedSet<Unit> units, Unit unit) {
        Person person = Authenticate.getUser().getPerson();
        if (person != null && InternalRequest.doesPersonBelongToUnit(person, unit)) {
