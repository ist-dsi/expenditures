/*
 * @(#)ExternalRequestSyncTaskMgpISTID.java
 *
 ...
 * 
 */
public class ExternalRequestSyncTaskMgpISTID extends ExternalRequestSyncTaskMgpISTID_Base {

    public ExternalRequestSyncTaskMgpISTID() {
        super();
    }
