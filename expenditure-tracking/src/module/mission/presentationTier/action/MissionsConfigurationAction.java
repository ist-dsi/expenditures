...
public class MissionsConfigurationAction extends ContextBaseAction {
    ...
    public ActionForward prepareSelectOrganizationalModel(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
    ...
    public ActionForward prepareAddMissionAuthorizationAccountabilityType(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
    ...
    public ActionForward addMissionAuthorizationAccountabilityType(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	MissionAuthorizationAccountabilityTypeBean missionAuthorizationAccountabilityTypeBean = getRenderedObject();
    ...
    public ActionForward deleteMissionAuthorizationAccountabilityType(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	final MissionAuthorizationAccountabilityType missionAuthorizationAccountabilityType = getDomainObject(request, "missionAuthorizationAccountabilityTypeOid");
	missionAuthorizationAccountabilityType.delete();
	return prepare(mapping, form, request, response);
    }

    public ActionForward prepareCreateDailyPersonelExpenseTable(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
    ...
    public ActionForward createDailyPersonelExpenseTable(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	final DailyPersonelExpenseTableBean dailyPersonelExpenseTableBean = getRenderedObject();
	final DailyPersonelExpenseTable dailyPersonelExpenseTable = dailyPersonelExpenseTableBean.createDailyPersonelExpenseTable();
	return viewDailyPersonelExpenseTable(request, dailyPersonelExpenseTable);
    }

    public ActionForward viewDailyPersonelExpenseTable(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	final DailyPersonelExpenseTable dailyPersonelExpenseTable = getDomainObject(request, "dailyPersonelExpenseTableOid");
	return viewDailyPersonelExpenseTable(request, dailyPersonelExpenseTable);
    }

    public ActionForward viewDailyPersonelExpenseTable(final HttpServletRequest request, final DailyPersonelExpenseTable dailyPersonelExpenseTable) {
    ...
    public ActionForward editDailyPersonelExpenseTable(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	final DailyPersonelExpenseTable dailyPersonelExpenseTable = getDomainObject(request, "dailyPersonelExpenseTableOid");
	return editDailyPersonelExpenseTable(request, dailyPersonelExpenseTable);
    }

    private ActionForward editDailyPersonelExpenseTable(HttpServletRequest request, DailyPersonelExpenseTable dailyPersonelExpenseTable) {
	request.setAttribute("dailyPersonelExpenseTable", dailyPersonelExpenseTable);
	return forward(request, "/mission/editDailyPersonelExpenseTable.jsp");
    }

    public ActionForward deleteDailyPersonelExpenseTable(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	final DailyPersonelExpenseTable dailyPersonelExpenseTable = getDomainObject(request, "dailyPersonelExpenseTableOid");
    ...
    public ActionForward prepareCreateDailyPersonelExpenseCategory(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	final DailyPersonelExpenseTable dailyPersonelExpenseTable = getDomainObject(request, "dailyPersonelExpenseTableOid");
	final DailyPersonelExpenseCategoryBean dailyPersonelExpenseCategoryBean = new DailyPersonelExpenseCategoryBean(dailyPersonelExpenseTable);
    ...
    public ActionForward createDailyPersonelExpenseCategory(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
    ...
    public ActionForward editDailyPersonelExpenseCategory(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	final DailyPersonelExpenseCategory dailyPersonelExpenseCategory = getDomainObject(request, "dailyPersonelExpenseCategoryOid");
    ...
    public ActionForward deleteDailyPersonelExpenseCategory(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
	    final HttpServletResponse response) {
	final DailyPersonelExpenseCategory dailyPersonelExpenseCategory = getDomainObject(request, "dailyPersonelExpenseCategoryOid");
