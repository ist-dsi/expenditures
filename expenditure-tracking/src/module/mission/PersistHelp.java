...
//	VaadinNode.createVaadinNode(virtualHost, node, "resources.MissionResources", "link.sideBar.help", "SectionedPage-" + page.getExternalId(), UserGroup.getInstance());
	VaadinNode.createVaadinNode(virtualHost, node, "resources.MissionResources", "link.sideBar.help", "SectionedPageViewer-" + page.getExternalId(), UserGroup.getInstance());
	...
	set(introduction,
		"text.help.content.introduction.paragraph1",
		"text.help.content.introduction.paragraph2",
		"text.help.content.introduction.paragraph3",
		"text.help.content.introduction.paragraph4");
	...
	set(create, "text.help.title.createMissionProcess.paragraph1"
		, "text.help.title.createMissionProcess.paragraph2"
		, "text.help.title.createMissionProcess.paragraph3"
		, "text.help.title.createMissionProcess.paragraph4"
		, "text.help.title.createMissionProcess.paragraph5"
		, "text.help.title.createMissionProcess.paragraph6"
		, "text.help.title.createMissionProcess.paragraph7"
		, "text.help.title.createMissionProcess.paragraph8");
	...
	set(manageItems1, "text.help.content.manageItems.add.paragraph1"
		, "text.help.content.manageItems.add.paragraph2"
		, "text.help.content.manageItems.add.paragraph3"
		, "text.help.content.manageItems.add.paragraph4"
		, "text.help.content.manageItems.add.paragraph5");
	final Section manageItems2 = add(manageItems, "text.help.title.manageItems.edit");
	set(manageItems2, "text.help.content.manageItems.edit.paragraph1"
		, "text.help.content.manageItems.edit.paragraph2");
	...
	set(submitForApproval, "text.help.content.submitForApproval.paragraph1"
		, "text.help.content.submitForApproval.paragraph2"
		, "text.help.content.submitForApproval.paragraph3"
	...
	final Section fundAllocationAndParticipantAuthorization = add(page, "text.help.title.fundAllocationAndDislocationAuthorization");
	...
	set(fundAllocation, "text.help.content.fundAllocation.paragraph1"
		, "text.help.content.fundAllocation.paragraph2"
		, "text.help.content.fundAllocation.paragraph3"
		, "text.help.content.fundAllocation.paragraph4");
	...
	set(fundAllocation1, "text.help.content.fundAllocation.projects.paragraph1"
		, "text.help.content.fundAllocation.projects.paragraph2"
		, "text.help.content.fundAllocation.projects.paragraph3"
		, "text.help.content.fundAllocation.projects.paragraph4"
		, "text.help.content.fundAllocation.projects.paragraph5"
		, "text.help.content.fundAllocation.projects.paragraph6"
		, "text.help.content.fundAllocation.projects.paragraph7"
		, "text.help.content.fundAllocation.projects.paragraph8"
		, "text.help.content.fundAllocation.projects.paragraph9"
		, "text.help.content.fundAllocation.projects.paragraph10"
		, "text.help.content.fundAllocation.projects.paragraph11"
		, "text.help.content.fundAllocation.projects.paragraph12"
		, "text.help.content.fundAllocation.projects.paragraph13"
	...
	final Section participantAuthorization = add(fundAllocationAndParticipantAuthorization, "text.help.title.dislocationAuthorization");
	set(participantAuthorization, "text.help.content.dislocationAuthorization.paragraph1"
		, "text.help.content.dislocationAuthorization.paragraph2"
		, "text.help.content.dislocationAuthorization.paragraph3"
	...
	final Section participantAuthorization2 = add(participantAuthorization, "text.help.title.dislocationAuthorization.scientificCouncil");
	...
	final Section participantAuthorization3 = add(participantAuthorization, "text.help.title.dislocationAuthorization.managementCouncil");
	...
	final Section participantAuthorization4 = add(participantAuthorization, "text.help.title.dislocationAuthorization.president");
	...
	set(expenseAuthorization, "text.help.content.expenseAuthorization.paragraph1"
		, "text.help.content.expenseAuthorization.paragraph2"
		, "text.help.content.expenseAuthorization.paragraph3"
		, "text.help.content.expenseAuthorization.paragraph4"
		, "text.help.content.expenseAuthorization.paragraph5"
		, "text.help.content.expenseAuthorization.paragraph6"
		, "text.help.content.expenseAuthorization.paragraph7");
	...
	set(archievedProcess, "text.help.content.archieveProcess.paragraph1"
		, "text.help.content.archieveProcess.paragraph2");
	...
	final StringBuilder stringBuilder = contents != null && contents.hasContent() ?
		new StringBuilder(contents.getContent()) : new StringBuilder();
