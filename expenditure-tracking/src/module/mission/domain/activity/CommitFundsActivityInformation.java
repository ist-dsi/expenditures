...
public class CommitFundsActivityInformation extends ActivityInformation<MissionProcess> implements Serializable {
    ...
    private final Collection<MissionFinancerCommitFundAllocationBean> missionFinancerCommitFundAllocationBeans = new ArrayList<MissionFinancerCommitFundAllocationBean>();
