...
public class ListMissionsJune2011 extends ReadCustomTask {
	...
	TreeSet<Mission> missions = new TreeSet<Mission>(
		ComparatorUtils.reversedComparator(Mission.COMPARATOR_BY_PROCESS_IDENTIFICATION));
	...
	for (final Mission mission : missions) {
	    ...
	    Map<MissionStage, MissionStageState> stages = process.getMissionStageView().getMissionStageStates();
