...
<logic:notEmpty name="accountingUnits">
	<bean:define id="selectUrl">/expenditureTrackingOrganization.do?method=addToProjectAccountingUnit&amp;personOid=<bean:write name="person" property="externalId"/></bean:define>
