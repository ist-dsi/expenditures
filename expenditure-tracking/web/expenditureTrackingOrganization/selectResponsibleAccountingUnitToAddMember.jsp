...
<h2><bean:message key="accountingUnit.title.add.responsible" bundle="EXPENDITURE_RESOURCES"/></h2>
...
<logic:notEmpty name="accountingUnits">
	<bean:define id="selectUrl">/expenditureTrackingOrganization.do?method=addResponsibleAccountingUnit&amp;personOid=<bean:write name="person" property="externalId"/></bean:define>
