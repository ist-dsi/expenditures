...
<h2>
	...
	<span class="processType">
		...
		<logic:equal name="process" property="mission.grantOwnerEquivalence" value="true">
			<bean:message bundle="MISSION_RESOURCES" key="title.mission.process.national.grantOwnerEquivalence"/>
		</logic:equal>
		<logic:notEqual name="process" property="mission.grantOwnerEquivalence" value="true">
			<bean:message bundle="MISSION_RESOURCES" key="title.mission.process.national"/>
		</logic:notEqual>
		)
	</span>
</h2>
