...
<bean:define id="maxValue" name="refundItem" property="value.roundedValue"/>
...
<div class="dinline forminline">
	<fr:form action='<%="/acquisition" + processClass + ".do?refundProcessOid=" + processOID + "&refundItemOid=" + refundItemOid%>'>
	...
	<fr:form action='<%="/acquisition" + processClass +".do?method=viewRefundProcess&refundProcessOid=" + processOID + "&refundItemOid=" + refundItemOid%>'>
