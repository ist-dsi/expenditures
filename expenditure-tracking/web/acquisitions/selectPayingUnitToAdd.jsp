...
action='<%= actionMapping + ".do?method=addPayingUnit&acquisitionProcessOid=" + processOID%>'>
	<fr:destination name="cancel" path='<%= actionMapping + ".do?method=viewAcquisitionProcess&acquisitionProcessOid=" + processOID %>'/>
