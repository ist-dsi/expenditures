...
<p>
	<html:link action="<%= "/acquisition" + processClass + ".do?method=viewProcess"%>" paramId="processOid" paramName="process" paramProperty="externalId">
...
<div class="mtop2">
	<logic:equal name="process" property="class.name" value="pt.ist.expenditureTrackingSystem.domain.acquisitions.simplified.SimplifiedProcedureProcess">
		<html:img action="statistics.do?method=simplifiedProcessStatisticsActivityTimeChartForProcess" paramId="processId" paramName="process" paramProperty="externalId"/>
	</logic:equal>
	<logic:equal name="process" property="class.name" value="pt.ist.expenditureTrackingSystem.domain.acquisitions.refund.RefundProcess">
		<html:img action="statistics.do?method=refundProcessStatisticsActivityTimeChartForProcess" paramId="processId" paramName="process" paramProperty="externalId"/>
	</logic:equal>
</div>
