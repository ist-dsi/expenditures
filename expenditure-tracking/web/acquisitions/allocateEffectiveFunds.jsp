...
<bean:define id="urlActivity">/acquisitionProcess.do?method=allocateFundsPermanently&amp;acquisitionProcessOid=<bean:write name="acquisitionProcess" property="OID"/></bean:define>
