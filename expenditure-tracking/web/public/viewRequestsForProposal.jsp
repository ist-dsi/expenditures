...
<logic:iterate id="requestProcess" name="activeRequests" indexId="Id">
	<div class="infoop2">
		<table class="tstyle1">
			...
			<tr>
				<td colspan="2">
					<html:link page="/expendituresHome.do?method=viewRequestForProposalProcess" paramId="requestForProposalProcessOid" paramName="requestProcess" paramProperty="externalId">
