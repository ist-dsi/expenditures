...
<a id="addFundAllocationLink" style="display: none;" href="<%= request.getContextPath() + "/expenditureProcesses.do?method=addAllocationFundForProject&processId=" + processId %>"></a>
<a id="removeFundAllocationLink" style="display: none;" href="<%= request.getContextPath() + "/expenditureProcesses.do?method=removeAllocationFundForProject&processId=" + processId %>"></a>
