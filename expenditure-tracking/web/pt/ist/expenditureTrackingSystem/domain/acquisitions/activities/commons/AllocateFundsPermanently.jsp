...
<a id="addFundAllocationLink" style="display: none;" href="<%= request.getContextPath() + "/expenditureProcesses.do?method=addAllocationFund&processId=" + processId %>"></a>
<a id="removeFundAllocationLink" style="display: none;" href="<%= request.getContextPath() + "/expenditureProcesses.do?method=removeAllocationFund&processId=" + processId %>"></a>
