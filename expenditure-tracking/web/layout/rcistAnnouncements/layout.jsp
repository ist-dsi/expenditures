...
<!-- START HEADER -->
	<div id="logoist">
		<h1><%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.RequestRewriter.HAS_CONTEXT_PREFIX %><a href="http://www.ist.utl.pt">Instituto Superior T�cnico</a></h1>
		<!-- <img alt="[Logo] Instituto Superior T�cnico" height="51" src="http://www.ist.utl.pt/img/wwwist.gif?contentContextPath_PATH=/homepage/ist12628/publicacoes&amp;_request_checksum_=066ce7940c117595bbc905fa691e9ed77e0814ab" width="234" /> -->
	</div>
