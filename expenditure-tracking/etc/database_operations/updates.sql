...
rename table ACQUISITION_PROCESS_YEAR to PAYMENT_PROCESS_YEAR;
alter table GENERIC_PROCESS change column KEY_ACQUISITION_PROCESS_YEAR KEY_PAYMENT_PROCESS_YEAR  int(11) default NULL;
