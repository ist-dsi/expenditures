/*
 * @(#)UnVerifyWorkingCapitalAcquisitionActivity.java
 *
 ...
 * 
 */
public class UnVerifyWorkingCapitalAcquisitionActivity extends WorkflowActivity<WorkingCapitalProcess, WorkingCapitalTransactionInformation> {
