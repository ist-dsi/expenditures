...
public enum WorkingCapitalProcessState implements PresentableProcessState {
    ...
    PENDING_ACCEPT_RESPONSIBILITY, PENDING_APPROVAL, PENDING_VERIFICATION, PENDING_FUND_ALLOCATION, PENDING_AUTHORIZATION,
    PENDING_PAYMENT, WORKING_CAPITAL_AVAILABLE, SENT_FOR_TERMINATION, SENT_FOR_FUND_REFUND, TERMINATED, CANCELED(false) {
